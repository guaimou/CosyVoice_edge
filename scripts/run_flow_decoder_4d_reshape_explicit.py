...
PREP_ROOT = OUTPUT_DIR / "flow_decoder_4d_reshape_explicit"
RESULT_ROOT = OUTPUT_DIR / "flow_decoder_4d_reshape_explicit_result"
...
DEFAULT_ESTIMATOR = OUTPUT_DIR / "flow.decoder.estimator.input_ncf_explicit_4d_reshape.onnx"
DEFAULT_DLC = OUTPUT_DIR / "flow.decoder.estimator.input_ncf_explicit_4d_reshape.dlc"
...
def run_docker(prep_dir: Path, result_dir: Path, dlc_path: Path, container: str, snpe_project: str, snpe_root: str) -> None:
    ...
    container_output = f"{snpe_project}/flow_decoder_4d_reshape_explicit_result"
...
def main() -> None:
    ...
    run_python(make_script, "--input", str(base_estimator), "--output", str(estimator_path), "--mode", "4d_reshape")
